<#
    .SYNOPSIS
        Export Spotify playlists to an Azure CosmosDB collection
    .DESCRIPTION
        Export Spotify playlists to an Azure CosmosDB using the Spotify web API with OAuth2 Client Authorization flow
    .NOTES
